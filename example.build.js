...
var lithuanianIslands = ['Bažnytėlė Island', 'Briedžiai Island', 'Jonava Neris Island', 'Kiaulės Nugara', 'Kiemas Island', 'Kubiliai Island', 'Nemunas Island', 'Ragininkai Island', 'Rusnė Island', 'Pilis Island', 'Triušiai Island', 'Vytinė', 'Žingelinė', 'Žvėrynas Neris Island'];
    ...
    return (0, _virtualElement2.default)(
      ...
      (0, _virtualElement2.default)(
        ...
        props.items.map(function (island, i) {
          ...
          return (0, _virtualElement2.default)(
            'li',
            { 'class': selected ? 'list-item is-selected' : 'list-item',
...
},{"base64-js":3,"ieee754":25,"is-array":26}],5:[function(require,module,exports){
...
},{"./events":9,"./node-type":11,"./svg":14,"component-raf":6,"fast.js/forEach":17,"fast.js/object/assign":20,"fast.js/reduce":23,"get-uid":24,"is-dom":27,"object-defaults":30,"object-path":31}],13:[function(require,module,exports){
var defaults = require('object-defaults')
var nodeType = require('./node-type')
var type = require('component-type')
...
},{"is-svg-attribute":28,"is-svg-element":29}],15:[function(require,module,exports){
'use strict';
...
var ItemSelection = (function () {
  function ItemSelection(items) {
    ...
    var lastIndex = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
  ...
  _createClass(ItemSelection, [{
    ...
    key: 'set',
    value: function set(selection, lastIndex) {
      return new ItemSelection(this.items, selection, lastIndex);
    }
  }, {
    key: 'isSelectedIndex',
    value: function isSelectedIndex(index) {
    ...
    value: function add(index) {
      return this.set([].concat(_toConsumableArray(this.selection), [index]), this.lastIndex);
    }
  }, {
    key: 'remove',
    ...
    key: 'selectToggle',
    value: function selectToggle(index) {
      if (this.isSelectedIndex(index)) {
        return this.remove(index);
      }
      return this.set([].concat(_toConsumableArray(this.selection), [index]), index);
    }
  }, {
    key: 'selectAll',
